    ...
    <main>
        <section class="product-details">
            ...
            <div class="video-container">
                ...
                <img src="Gallery/details16.jpg" height="750">
                <img src="Gallery/iphone16colour.jpg" height="750">
                <img src="Gallery/box.jpg" height="750">
            </div>
                ...
                <div class="product-info">
                    ...
                    <div class="color-options">
                        ...
                        <button class="color-option"
                            data-color="blue"
                            data-image="Gallery/iphone16_blue.jpg"></button>
                        <button class="color-option"
                            data-color="white"
                            data-image="Gallery/iphone16_white.jpg"></button>
                        <button class="color-option"
                            data-color="black"
                            data-image="Gallery/iphone16_black.jpg"></button>
                    </div>
